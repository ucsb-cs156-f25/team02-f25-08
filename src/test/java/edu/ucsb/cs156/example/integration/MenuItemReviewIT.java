...
public class MenuItemReviewIT {
  ...
  public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
    ...
    // assert
    menuitemreview.setId(1L); // id is assigned by the database upon save
  ...
  public void an_admin_user_can_post_a_new_menuitemreview() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/menuitemreview/post?itemId=1&reviewerEmail=krystellebaluyot@ucsb.edu&stars=4&dateReviewed=2022-01-03T00:00&comments=good")
                    .with(csrf()))
