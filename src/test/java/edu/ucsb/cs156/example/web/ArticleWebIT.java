...
public class ArticleWebIT extends WebTestCase {
  ...
  public void admin_user_can_create_edit_delete_article() throws Exception {
    ...
    page.getByTestId("ArticlesForm-id");
    page.getByTestId("ArticlesForm-title").fill("Article1Title");
    page.getByTestId("ArticlesForm-url").fill("https://article1.com");
    page.getByTestId("ArticlesForm-explanation").fill("Article1Explanation");
    page.getByTestId("ArticlesForm-email").fill("daliasebat1@gmail.com");
    page.getByTestId("ArticlesForm-dateAdded").fill(ldt1.toString());
    page.getByTestId("ArticlesForm-submit").click();

    assertThat(page.getByTestId("ArticlesTable-cell-row-0-col-explanation"))
        .hasText("Article1Explanation");

    page.getByTestId("ArticlesTable-cell-row-0-col-Edit-button").click();
    assertThat(page.getByText("Edit Article")).isVisible();
    page.getByTestId("ArticlesForm-explanation").fill("Article1ExplanationNEW");
    page.getByTestId("ArticlesForm-submit").click();

    assertThat(page.getByTestId("ArticlesTable-cell-row-0-col-explanation"))
        .hasText("Article1ExplanationNEW");
