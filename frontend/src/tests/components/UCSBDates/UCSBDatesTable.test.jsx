...
describe('UserTable tests', () => {
  ...
  test('Edit button navigates to the edit page for admin user', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByTestId(`UCSBDatesTable-cell-row-0-col-id`)).toHaveTextContent('1');
    });
  ...
  test('Delete button calls delete callback', async () => {
    ...
    axiosMock.onDelete('/api/ucsbdates').reply(200, { message: 'Date deleted' });
    ...
    const deleteButton = screen.getByTestId(`UCSBDatesTable-cell-row-0-col-Delete-button`);
    expect(deleteButton).toBeInTheDocument();
