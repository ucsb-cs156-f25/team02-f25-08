...
describe("RecommendationRequestEditPage tests", () => {
  ...
  describe("tests where backend is working normally", () => {
    ...
    test("Is populated with the data provided", async () => {
      ...
      expect(requesterEmailField).toHaveValue("sriya.vollala@gmail.com");
      expect(professorEmailField).toHaveValue("pconrad@ucsb.edu");
      expect(explanationField).toHaveValue("rara");
    ...
    test("Changes when you click Update", async () => {
      ...
      fireEvent.change(requesterEmailField, {
        target: { value: "sriyavollala@ucsb.edu" },
      });
      ...
      expect(axiosMock.history.put[0].data).toBe(
        JSON.stringify({
          requesterEmail: "sriyavollala@ucsb.edu",
